...
cp "${ROOT_DIR}/configs/prompts/prompt-tags.yaml" "${DIST_DIR}/prompt-tags.yaml"
cp "${ROOT_DIR}/configs/prompts/generic-prompts.yaml" "${DIST_DIR}/generic-prompts.yaml"
cp "${ROOT_DIR}"/themes/*.yaml "${DIST_DIR}/themes/"
cp "${ROOT_DIR}"/locales/*.yaml "${DIST_DIR}/locales/"
cp -R "${ROOT_DIR}/assets/." "${DIST_DIR}/assets/"
cp "${ROOT_DIR}/scripts/release/release-install.sh" "${DIST_DIR}/scripts/install.sh"
